                                                            ...
                                                            <td>
                                                                <div style="font-family: sans-serif">
                                                                    <div
                                                                        ...
                                                                        <p>
                                                                            ID ของ Email {!! $email !!}
                                                                            นี้ ไม่ได้เข้าใช้งานในระบบ ปกป้อง (CRS)
                                                                            มาเป็นเวลานาน 
                                                                            <br><br>
                                                                            หากยังไม่ได้มีการเข้าใช้งาน  
                                                                            <strong style="color: #ec5075;">นับจากที่ได้ Email ฉบับนี้ ภายใน 7 วัน</strong>
                                                                            ทางทีมผู้ดูแลระบบ ขออนุญาตปิดการเข้าใช้งานระบบชั่วคราว ใน ID
                                                                            ของ Email ดังกล่าวนี้

                                                                            <br><br>
                                                                            และเมื่อ ID นี้ได้มีการปิดการเข้าใช้งานแล้ว และท่านยังต้องการเข้าใช้งานอีกครั้ง
                                                                            <br>
                                                                            กรุณาติดต่อมาที่ทีมผู้ดูแลระบบ เพื่อขอเข้าใช้ระบบอีกครั้ง <br>
                                                                            ติดต่อได้ที่ 
